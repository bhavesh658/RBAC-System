...
leadSchema.index({ isDeleted: 1, assignedTo: 1 });
leadSchema.index({ isDeleted: 1, email: 1 });
leadSchema.index({ isDeleted: 1, phone: 1 });
leadSchema.index({ isDeleted: 1, department: 1 });
